...
function createGooglePlayClient() {
    ...
    const packageName = String(process.env.GOOGLE_PLAY_PACKAGE_NAME || 'com.aistudio.aibrowser.qyzkdf').trim();
    const productId = String(process.env.GOOGLE_PLAY_SUBSCRIPTION_ID || 'ai_browser_pro').trim();
