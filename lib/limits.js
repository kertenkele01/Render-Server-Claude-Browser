 ...
 * | password changes       | linked-device guessing and hash load |
...
const WINDOWS = {
    ...
    // Count every password-change request, including successful ones. Otherwise
    // a caller who knows their own password can repeatedly run the costly hash.
    passwordChange: { windowMs: 10 * 60 * 1000, max: envMax('LIMIT_PASSWORD_CHANGE_MAX', 10) },
